...
trait Transform2 {
    ...
    fun at(location : Vector2) : Transform2 = Transforms.translation(-location).before(this).before(Transforms.translation(location))
}
...
fun transformOf(linearMatrix : Matrix2 = identityMatrix2, translation : Vector2 = zeroVector2) = transformOf(
        matrixOf(
                linearMatrix[0,0], linearMatrix[0,0], translation[0],
                linearMatrix[0,0], linearMatrix[0,0], translation[1],
                0,0,1)
)
